...
## Ekipman Envanteri migration
Mevcut AGM motor kayıtlarının yeni evrensel envanter yapısına uyarlanması için bir kez çalıştırın:
`npm run migrate:equipment`
Mevcut kayıtlar `equipmentType: motor` olarak işaretlenir; arıza geçmişi korunur.
