...
export default function NewBreakdown() {
    ...
    return <><h1 className="page-title">Yeni Arıza Kaydı</h1><p className="muted">Arızayı mümkün olduğunca ayrıntılı girin. Kayıt oluşturulduğunda yöneticilere bildirim gönderilir.</p><div className="card form" style={{ marginTop: 16 }}>
